...
class RentalServiceImplTest {
	...
	public void rentVideos_moviesListEmpty_EmptyMoviesListException() {
		cut.rentVideos(new RentDto(0, Lists.newArrayList(), 0, 1));
	}
	...
	public void rentVideos_daysLowerEqualNil_IncorrectRentalPeriodException() {
		cut.rentVideos(new RentDto(0, Lists.newArrayList(regularAvailableVideoDto()), 0, 1));
	}

	@Test(expected = ResourceNotFoundException.class)
	public void rentVideos_incorrectVideoId_ResourceNotFoundException() {
		cut.rentVideos(new RentDto(0, Lists.newArrayList(regularAvailableVideoDto()), 3, 1));
	}
	...
	public void rentVideos_videoInTheListNotAvailable_VideoNotAvailableException() {
		...
		cut.rentVideos(new RentDto(0, Lists.newArrayList(newReleaseNotAvailableVideoDto()), 3, 1));
	}
	...
	@Test
	public void returnMovies_noDelay_InEqualsOut() {
		fail("Not yet implemented");
	}

	@Test
	public void returnMovies_existsDelay_InNotEqualsOut_AmountToPayHigherAmountPayed() {
		fail("Not yet implemented");
	}
